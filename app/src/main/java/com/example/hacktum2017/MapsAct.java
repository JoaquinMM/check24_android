...
public class MapsAct extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        /******   IMPORTANT     ****/
        markerOptions.title("Wathever we want");
    ...
    public boolean checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(contexto,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity)contexto,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {
                ...
                ActivityCompat.requestPermissions((Activity)contexto,
    ...
    public double devuelveLat() {
        return this.mLastLocation.getLatitude();

    }
    public double devuelveLon() {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://net.simplifiedcoding.volleymapa/http/host/path")
        );
